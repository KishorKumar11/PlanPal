      ...
      <div className="relative w-full max-w-sm">
        ...
        <GlowCard className="p-8">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 rounded-xl border border-white/20 bg-white/5 px-4 py-3 text-sm font-semibold text-text-bright hover:bg-white/10 transition-colors"
            >
